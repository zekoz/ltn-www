...
class OldUser(models.Model):
        ...
        activeuser        = models.ForeignKey(User, related_name="activeuser", blank=True, null=True, on_delete=models.CASCADE)
...
class OldJoined(models.Model):
        user = models.ForeignKey(OldUser, related_name="user", on_delete=models.CASCADE)
